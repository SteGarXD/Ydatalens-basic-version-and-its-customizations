...
log "Next steps:"
log ""
log "1. Repository on GitHub (SteGarXD):"
log "   - Repository name: Ydatalens-basic-version-and-its-customizations"
log "   - Description: Base DataLens and customizations"
log ""
log "2. Add remote and push:"
log "   cd $DATALENS_DIR"
log "   git remote add origin https://github.com/SteGarXD/Ydatalens-basic-version-and-its-customizations.git"
log "   git checkout -b base"
log "   git push -u origin base"
